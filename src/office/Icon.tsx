...
const PATHS: Record<IconName, string> = {
  ...
  key: 'M14.5 4a5.5 5.5 0 1 1-3.9 9.4L4 20v-3h3v-3h3l.6-.6A5.5 5.5 0 0 1 14.5 4Zm2 3.5h.01',
  wrench: 'M14.7 6.3a4 4 0 0 1 5-1.2l-2.9 2.9.4 2.4 2.4.4 2.9-2.9a4 4 0 0 1-5.4 5.1L7.5 20.6a2 2 0 0 1-2.8-2.8L12 10.5a4 4 0 0 1 2.7-4.2Z',
  building: 'M4 21h16M6 21V5l7-2v18M13 8h5v13M9 8h1m-1 4h1m-1 4h1m6-4h.01M16 16h.01',
  meter: 'M4 15a8 8 0 1 1 16 0M12 15l4-5M8 19h8M12 7v1.5M7 10l1 1M17 10l-1 1',
